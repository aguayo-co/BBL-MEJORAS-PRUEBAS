# Generated by Django 2.2.10 on 2022-10-21 15:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('expositions', '0046_contentpage'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='contentpage',
            options={'verbose_name': 'Página de contenido', 'verbose_name_plural': 'Páginas de contenido'},
        ),
