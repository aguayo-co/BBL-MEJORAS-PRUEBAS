...
class GetHitCount(template.Node):
    ...
    def render(self, context):
        hit_count = get_hit_count_from_obj_variable(
            context, self.obj_variable, "get_hit_count"
        )
...
class WriteHitCountJavascriptVariables(template.Node):
    ...
    def render(self, context):
        hit_count = get_hit_count_from_obj_variable(
            context, self.obj_variable, "insert_hit_count_js_variables"
        )
...
class GetHitCountJavascriptVariables(template.Node):
    ...
    def render(self, context):
        ...
        hit_count = get_hit_count_from_obj_variable(
            context, self.obj_variable, "get_hit_count_js_variables"
        )
...
"""
    ...
    def render(self, context):
        hit_count = get_hit_count_from_obj_variable(
            context, self.obj_variable, "insert_hit_count_js"
        )
