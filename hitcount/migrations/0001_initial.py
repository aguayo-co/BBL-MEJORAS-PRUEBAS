...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.ForeignKey(
                        related_name="content_type_set_for_hitcount",
        ...
        migrations.AlterUniqueTogether(
            name="hitcount", unique_together=set([("content_type", "object_pk")])
        ),
        migrations.AddField(
            model_name="hit",
            name="hitcount",
            field=models.ForeignKey(
                editable=False, to="hitcount.HitCount", on_delete=models.CASCADE
            ),
