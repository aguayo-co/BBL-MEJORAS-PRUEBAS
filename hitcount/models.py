...
class HitCount(models.Model):
    ...
    hits = models.PositiveIntegerField(default=0, verbose_name=_("visitas"))
    modified = models.DateTimeField(auto_now=True, verbose_name=_("modificada el"))
    ...
    content_object.short_description = _("contenido")
...
class Hit(models.Model):
    ...
    created = models.DateTimeField(
        editable=False, auto_now_add=True, db_index=True, verbose_name=_("creada el")
    )
    ...
    user_agent = models.CharField(
        max_length=255, editable=False, verbose_name=_("navegador")
    )
    ...
    hitcount = models.ForeignKey(
        ...
        editable=False,
        on_delete=models.CASCADE,
        verbose_name=_("contenido visitado"),
    )
...
class BlacklistUserAgent(models.Model):
    ...
    user_agent = models.CharField(
        max_length=255, unique=True, verbose_name=_("navegador")
    )
